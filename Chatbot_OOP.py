...
class ChatBot:
    def __init__(
        ...
        self.model = model  # Set the model to use
        ...
        # Load encoding method for token counting
    ...
    def _get_encoding(self):
        try:
            ...
            print(f"⚠️ Warning: Tokenizer for model '{self.model}' not found. Using default encoding.")
